...
export default function DetailsScreen({ route, navigation }) {
    const { nama, latitude, longitude,
        ...
        kota, provinsi, kodepos, image } = route.params;

    useEffect(() => {
        const unsubscribe = navigation.addListener('focus', () => {
            StatusBar.setBackgroundColor("#595860");
    ...
    const handlePress = (nama, latitude, longitude, navigation) => {
        // console.log({ item });
        var nama = nama;
    ...
    return (
        <View style={[styles.container, { backgroundColor: "#595860" }]}>
            <MyHeader
                back
            ...
            <View style={styles.container}>
                ...
                <SharedElement style={styles.imageContainer}>
                    ...
                    <Image style={[styles.image, { backgroundColor: "#595860", borderColor: Colors.white, }]} resizeMode='center'
                ...
                <View style={styles.bottomContainer}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, position: 'absolute', bottom: 0, alignSelf: 'center' }}>
                        <TouchableOpacity style={[styles.cartBtm, { borderColor: "#595860" }]}>
                            <Icon type={Icons.Entypo} name="location" color={"#595860"} />
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.btn, { backgroundColor: "#595860" }]} onPress={() => { handlePress(nama, latitude, longitude, navigation); }}>
